...
import { getOwned, removeOwned } from "../api/me";
...
export function OwnedPage() {
  ...
  if (loading) return <p className="loading">Loading owned…</p>;
  return (
    <div>
      <h1>My Owned</h1>
      <p>
      ...
      {games.length === 0 && !error && <p>No owned games yet.</p>}
    </div>
  );
}
